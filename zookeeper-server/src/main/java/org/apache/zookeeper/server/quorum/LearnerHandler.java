            ...
            while (true) {
                ...
                switch (qp.getType()) {
                    ...
                    case Leader.REVALIDATE:
                        ...
                        if (valid) {
                            try {//set the session owner as the follower that owns the session
    ...
    public boolean syncFollower(long peerLastZxid, ZKDatabase db, Leader leader) {
        ...
        try {
            ...
            if (forceSnapSync) {
                ...
                // Use txnlog and committedLog to sync Calculate sizeLimit that we allow to retrieve txnlog from disk
